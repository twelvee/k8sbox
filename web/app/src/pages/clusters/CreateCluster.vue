            ...
            <div class="w-full p-6 pt-2">
              <div>
                ...
                <div class="mt-4">
                  ...
                  <button class="btn btn-primary btn-sm" @click="connectCluster">Connect cluster</button>
                </div>
...
export default {
  ...
  methods: {
    ...
    async connectCluster() {
      ...
      try {
        const response = await this.$store.dispatch('createCluster', {Name: this.name, Kubeconfig: this.kubeconfig})
